...
while True:
    num_sample_taken = int(input("Please enter the # of forage samples taken (Valid value = 1-20): "))
...
while True:
    utilization_rate = int(input('Please enter the utilization rate (Valid 1-100):  '))
...
while True:
    AUM = int(input('Please enter the animal unit (Valid 1-2000):  '))
...
# Calculate and display stocking rate and round to 2 decimal positions, and display the end of the program for the user.
