...
while True:
    ...
    while True:
        ration_alloc_depth = int(input('Rationed allocation depth(D) in inches: '))
    ...
    while True:
        area_irrigated_acres = int(input('Area being irrigated (A) in acres:      '))
    ...
    while True:
        aver_rate_flow = int(input('Average rate of flow(Q) in U.S. gpm:    '))
